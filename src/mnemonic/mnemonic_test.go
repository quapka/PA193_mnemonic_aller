...
//func TestPBKDF2_SHA512() {
// 	result,_ := PBKDF2_SHA512([]byte("password"),[]byte("salt"),1,64)
// 	expect_result := []byte{0x86,0x7F,0x70,0xCF,0x1A,0xDE,0x02,0xCF,0xF3,0x75,0x25,0x99,0xA3,
...
// 		fmt.fprintf(stderr,"Wrong result for PBKDF2_SHA512")
// 	}
// }
