...
// Must be use with module "testing"
// Parameter : a vector of testing.T type
...
func TestPbkdf2Sha512(t *testing.T) {
	testData := []struct {
		...
		{InputPassword: []byte("passwordPASSWORDpassword"),
			InputSalt:      []byte("saltSALTsaltSALTsaltSALTsaltSALTsalt"),
			InputCount:     4096,
			InputOutputLen: 64,

			Output: []byte{0x8C, 0x05, 0x11, 0xF4, 0xC6, 0xE5, 0x97, 0xC6, 0xAC, 0x63, 0x15, 0xD8, 0xF0, 0x36, 0x2E, 0x22, 0x5F, 0x3C, 0x50, 0x14,
				0x95, 0xBA, 0x23, 0xB8, 0x68, 0xC0, 0x05, 0x17, 0x4D, 0xC4, 0xEE, 0x71, 0x11, 0x5B, 0x59, 0xF9, 0xE6, 0x0C, 0xD9, 0x53, 0x2F, 0xA3,
				0x3E, 0x0F, 0x75, 0xAE, 0xFE, 0x30, 0x22, 0x5C, 0x58, 0x3A, 0x18, 0x6C, 0xD8, 0x2B, 0xD4, 0xDA, 0xEA, 0x97, 0x24, 0xA3, 0xD3, 0xB8},
		},
		{InputPassword: []byte("passDATAb00AB7YxDTT"),
			InputSalt:      []byte("saltKEYbcTcXHCBxtjD"),
			InputCount:     100000,
			InputOutputLen: 64,

			Output: []byte{0xAC, 0xCD, 0xCD, 0x87, 0x98, 0xAE, 0x5C, 0xD8, 0x58, 0x04, 0x73, 0x90, 0x15, 0xEF, 0x2A, 0x11, 0xE3, 0x25, 0x91,
				0xB7, 0xB7, 0xD1, 0x6F, 0x76, 0x81, 0x9B, 0x30, 0xB0, 0xD4, 0x9D, 0x80, 0xE1, 0xAB, 0xEA, 0x6C, 0x98, 0x22, 0xB8, 0x0A, 0x1F,
				0xDF, 0xE4, 0x21, 0xE2, 0x6F, 0x56, 0x03, 0xEC, 0xA8, 0xA4, 0x7A, 0x64, 0xC9, 0xA0, 0x04, 0xFB, 0x5A, 0xF8, 0x22, 0x9F, 0x76, 0x2F, 0xF4, 0x1F},
		},
	}
