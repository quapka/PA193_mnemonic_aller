...
func TestPBKDF2_SHA512(t *testing.T) {
	result,_ := PBKDF2_SHA512([]byte("password"),[]byte("salt"),1,64)
	assert.Equal(t, result, []byte(0x86,0x7F,0x70,0xCF,0x1A,0xDE,0x02,0xCF,0xF3,0x75,0x25,0x99,0xA3,
		...
		0xD7,0xD6,0x8B,0x1D,0xA5,0x5E,0x63,0xF7,0x3B,0x60,0xA5,0x7F,0xCE), "Wrong result for PBKDF2_SHA512")
}
